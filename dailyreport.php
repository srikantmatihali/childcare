...
$query="SELECT COUNT( rating ) as count , rating FROM  `ratings` WHERE school_id='".$school."' AND DATE(`date`) = '".$date."' GROUP BY rating ";
...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $siteurl;?>js/morris-0.5.1.css">
		<!--[if lt IE 9]>
